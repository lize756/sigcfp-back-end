...
public class SecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers(HttpMethod.POST, "/api/notis/**").hasAnyAuthority("ROLEE_LOCATION_COORDINATOR", "ROLEE_DIRECTOR") // Notificaciones por correo
                .antMatchers(HttpMethod.GET, "/api/notis/**").hasAnyAuthority("ROLEE_LOCATION_COORDINATOR", "ROLEE_DIRECTOR")// Notificaciones por correo
                .antMatchers(HttpMethod.PUT, "/api/notis/**").hasAnyAuthority("ROLEE_LOCATION_COORDINATOR", "ROLEE_DIRECTOR") // Notificaciones por correo
                .antMatchers(HttpMethod.DELETE, "/api/notis/**").hasAnyAuthority("ROLEE_LOCATION_COORDINATOR", "ROLEE_DIRECTOR") // Notificaciones por correo
