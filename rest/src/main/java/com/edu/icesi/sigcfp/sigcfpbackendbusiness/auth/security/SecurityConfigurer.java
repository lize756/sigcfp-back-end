...
public class SecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf().disable() // Disabling csrf
                ...
                .antMatchers(HttpMethod.POST, "/api/careers/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Carreras
                .antMatchers(HttpMethod.GET, "/api/careers/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString(),
                        TypesOfRolees.ROLEE_COMPANY.toString(), TypesOfRolees.ROLEE_GRADUATE.toString()) // Carreras
                .antMatchers(HttpMethod.PUT, "/api/careers/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Carreras
                .antMatchers(HttpMethod.DELETE, "/api/careers/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Carreras
                ...
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Estudios
                .antMatchers(HttpMethod.DELETE, "/api/academicStudies/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Estudios

                // Accesos a las rutas de las ciudades
                .antMatchers(HttpMethod.POST, "/api/cities/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Ciudades
                .antMatchers(HttpMethod.GET, "/api/cities/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Ciudades
                .antMatchers(HttpMethod.PUT, "/api/cities/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Ciudades
                .antMatchers(HttpMethod.DELETE, "/api/cities/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Ciudades
                ...
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString(),
                        TypesOfRolees.ROLEE_PROMOTION_COORDINATOR.toString(), TypesOfRolees.ROLEE_DIRECTOR.toString(),
                        TypesOfRolees.ROLEE_COMPANY.toString()) // Empresas
                .antMatchers(HttpMethod.PUT, "/api/companies/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString(),
                        TypesOfRolees.ROLEE_COMPANY.toString()) // Empresas
                .antMatchers(HttpMethod.DELETE, "/api/companies/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString(), "ROLEE_COMPANY") // Empresas
                ...
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString(),
                        TypesOfRolees.ROLEE_COMPANY.toString(), TypesOfRolees.ROLEE_DIRECTOR.toString(),
                        TypesOfRolees.ROLEE_PROMOTION_COORDINATOR.toString()) // Contactos
                .antMatchers(HttpMethod.PUT, "/api/contacts/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Contactos
                .antMatchers(HttpMethod.DELETE, "/api/contacts/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString(),
                        TypesOfRolees.ROLEE_COMPANY.toString()) // Contactos
                ...
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString(),
                        TypesOfRolees.ROLEE_COMPANY.toString(), TypesOfRolees.ROLEE_GRADUATE.toString()) // Curriculums
                .antMatchers(HttpMethod.DELETE, "/api/curriculums/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString(), "ROLEE_GRADUATE") // Curriculums
                ...
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Facultades
                .antMatchers(HttpMethod.GET, "/api/faculties/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Facultades
                .antMatchers(HttpMethod.PUT, "/api/faculties/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Facultades
                .antMatchers(HttpMethod.DELETE, "/api/faculties/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Facultades

                // Accesos a las rutas de las solicitudes de practicantes
                .antMatchers(HttpMethod.POST, "/api/internRequests/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString(),
                        TypesOfRolees.ROLEE_COMPANY.toString()) // Solicitudes de practicante
                .antMatchers(HttpMethod.GET, "/api/internRequests/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString(),
                        TypesOfRolees.ROLEE_COMPANY.toString(), TypesOfRolees.ROLEE_DIRECTOR.toString(),
                        TypesOfRolees.ROLEE_PROMOTION_COORDINATOR.toString()) // Solicitudes de practicante
                .antMatchers(HttpMethod.PUT, "/api/internRequests/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString(),
                        TypesOfRolees.ROLEE_COMPANY.toString(), TypesOfRolees.ROLEE_PROMOTION_COORDINATOR.toString()) // Solicitudes
                // de
                // practicante
                .antMatchers(HttpMethod.DELETE, "/api/internRequests/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString(),
                        TypesOfRolees.ROLEE_COMPANY.toString()) // Solicitudes de practicante
                ...
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Lenguajes
                .antMatchers(HttpMethod.DELETE, "/api/languages/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Lenguajes

                // Accesos a las rutas de las personas
                .antMatchers(HttpMethod.POST, "/api/persons/**").permitAll() // Personas
                .antMatchers(HttpMethod.GET, "/api/persons/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString(),
                        TypesOfRolees.ROLEE_PROMOTION_COORDINATOR.toString(), TypesOfRolees.ROLEE_DIRECTOR.toString(),
                        TypesOfRolees.ROLEE_GRADUATE.toString()) // Personas
                .antMatchers(HttpMethod.PUT, "/api/persons/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString(),
                        TypesOfRolees.ROLEE_DIRECTOR.toString(), TypesOfRolees.ROLEE_PROMOTION_COORDINATOR.toString(),
                        TypesOfRolees.ROLEE_GRADUATE.toString()) // Personas
                .antMatchers(HttpMethod.DELETE, "/api/persons/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Personas

                // Accesos a las rutas de los roles
                .antMatchers(HttpMethod.POST, "/api/rolees/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Roles
                .antMatchers(HttpMethod.GET, "/api/rolees/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Roles
                .antMatchers(HttpMethod.PUT, "/api/rolees/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Roles
                .antMatchers(HttpMethod.DELETE, "/api/rolees/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Roles

                // Accesos a las rutas de los usuarios
                .antMatchers(HttpMethod.POST, "/api/userrs/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString(), "ROLEE_PROMOTION_COORDINATOR") // Usuarios
                .antMatchers(HttpMethod.GET, "/api/userrs/**").permitAll() // Usuarios
                .antMatchers(HttpMethod.PUT, "/api/userrs/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Usuarios
                .antMatchers(HttpMethod.DELETE, "/api/userrs/**")
                .hasAnyAuthority(TypesOfRolees.ROLEE_LOCATION_COORDINATOR.toString()) // Usuarios

                // Accesos a las rutas de las notificaciones
                .antMatchers(HttpMethod.POST, "/api/notis/**")
                .hasAnyAuthority("ROLEE_LOCATION_COORDINATOR", "ROLEE_DIRECTOR") // Notificaciones por correo
                .antMatchers(HttpMethod.GET, "/api/notis/**")
                .hasAnyAuthority("ROLEE_LOCATION_COORDINATOR", "ROLEE_DIRECTOR")// Notificaciones por correo
                .antMatchers(HttpMethod.PUT, "/api/notis/**")
                .hasAnyAuthority("ROLEE_LOCATION_COORDINATOR", "ROLEE_DIRECTOR") // Notificaciones por correo
                .antMatchers(HttpMethod.DELETE, "/api/notis/**")
                .hasAnyAuthority("ROLEE_LOCATION_COORDINATOR", "ROLEE_DIRECTOR") // Notificaciones por correo

                .anyRequest().authenticated() // All other requests need to be authenticated

                .and().addFilter(new JWTAuthenticationFilter(authenticationManager(), jwtService)) // Agrega el filtro
                // de autenticación
                .addFilter(new JWTAuthorizationFilter(authenticationManager(), jwtService)) // Agrega el filtro de
                // autorización
